...
get.apiDoc = {
    ...
    tags: ['videos'],
    description:
        '録画ファイルの音声トラック一覧を取得する。完了済み録画はファイル全体、録画中は現在存在する範囲を probe する。音声 ES が 1 つだけのステレオ (二か国語放送のデュアルモノラルの可能性がある) は主音声・副音声の 2 件へ展開される。返ってきた track の値をストリーム API の audioTrack へ渡す',
    parameters: [
        {
