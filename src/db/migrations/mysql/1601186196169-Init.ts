...
export class Init1601186196169 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            'CREATE TABLE `rule` (`id` int NOT NULL AUTO_INCREMENT, `updateCnt` int NOT NULL DEFAULT 0, `isTimeSpecification` tinyint NOT NULL DEFAULT 0, `keyword` text NULL, `halfWidthKeyword` text NULL, `ignoreKeyword` text NULL, `halfWidthIgnoreKeyword` text NULL, `keyCS` tinyint NOT NULL DEFAULT 0, `keyRegExp` tinyint NOT NULL DEFAULT 0, `name` tinyint NOT NULL DEFAULT 0, `description` tinyint NOT NULL DEFAULT 0, `extended` tinyint NOT NULL DEFAULT 0, `ignoreKeyCS` tinyint NOT NULL DEFAULT 0, `ignoreKeyRegExp` tinyint NOT NULL DEFAULT 0, `ignoreName` tinyint NOT NULL DEFAULT 0, `ignoreDescription` tinyint NOT NULL DEFAULT 0, `ignoreExtended` tinyint NOT NULL DEFAULT 0, `GR` tinyint NOT NULL DEFAULT 0, `BS` tinyint NOT NULL DEFAULT 0, `CS` tinyint NOT NULL DEFAULT 0, `SKY` tinyint NOT NULL DEFAULT 0, `NW1` tinyint NOT NULL DEFAULT 0, `NW2` tinyint NOT NULL DEFAULT 0, `NW3` tinyint NOT NULL DEFAULT 0, `NW4` tinyint NOT NULL DEFAULT 0, `NW5` tinyint NOT NULL DEFAULT 0, `NW6` tinyint NOT NULL DEFAULT 0, `NW7` tinyint NOT NULL DEFAULT 0, `NW8` tinyint NOT NULL DEFAULT 0, `NW9` tinyint NOT NULL DEFAULT 0, `NW10` tinyint NOT NULL DEFAULT 0, `NW11` tinyint NOT NULL DEFAULT 0, `NW12` tinyint NOT NULL DEFAULT 0, `NW13` tinyint NOT NULL DEFAULT 0, `NW14` tinyint NOT NULL DEFAULT 0, `NW15` tinyint NOT NULL DEFAULT 0, `NW16` tinyint NOT NULL DEFAULT 0, `NW17` tinyint NOT NULL DEFAULT 0, `NW18` tinyint NOT NULL DEFAULT 0, `NW19` tinyint NOT NULL DEFAULT 0, `NW20` tinyint NOT NULL DEFAULT 0, `NW21` tinyint NOT NULL DEFAULT 0, `NW22` tinyint NOT NULL DEFAULT 0, `NW23` tinyint NOT NULL DEFAULT 0, `NW24` tinyint NOT NULL DEFAULT 0, `NW25` tinyint NOT NULL DEFAULT 0, `NW26` tinyint NOT NULL DEFAULT 0, `NW27` tinyint NOT NULL DEFAULT 0, `NW28` tinyint NOT NULL DEFAULT 0, `NW29` tinyint NOT NULL DEFAULT 0, `NW30` tinyint NOT NULL DEFAULT 0, `NW31` tinyint NOT NULL DEFAULT 0, `NW32` tinyint NOT NULL DEFAULT 0, `NW33` tinyint NOT NULL DEFAULT 0, `NW34` tinyint NOT NULL DEFAULT 0, `NW35` tinyint NOT NULL DEFAULT 0, `NW36` tinyint NOT NULL DEFAULT 0, `NW37` tinyint NOT NULL DEFAULT 0, `NW38` tinyint NOT NULL DEFAULT 0, `NW39` tinyint NOT NULL DEFAULT 0, `NW40` tinyint NOT NULL DEFAULT 0, `channelIds` text NULL, `genres` text NULL, `times` text NULL, `isFree` tinyint NOT NULL DEFAULT 0, `durationMin` int NULL, `durationMax` int NULL, `searchPeriods` text NULL, `enable` tinyint NOT NULL DEFAULT 0, `avoidDuplicate` tinyint NOT NULL DEFAULT 0, `periodToAvoidDuplicate` int NULL, `allowEndLack` tinyint NOT NULL DEFAULT 1, `tags` text NULL, `parentDirectoryName` text NULL, `directory` text NULL, `recordedFormat` text NULL, `mode1` text NULL, `parentDirectoryName1` text NULL, `directory1` text NULL, `mode2` text NULL, `parentDirectoryName2` text NULL, `directory2` text NULL, `mode3` text NULL, `parentDirectoryName3` text NULL, `directory3` text NULL, `isDeleteOriginalAfterEncode` tinyint NOT NULL DEFAULT 0, PRIMARY KEY (`id`)) ENGINE=InnoDB',
        );
        await queryRunner.query(
