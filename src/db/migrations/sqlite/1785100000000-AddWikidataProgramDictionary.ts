...
export class AddWikidataProgramDictionary1785100000000 implements MigrationInterface {
    ...
    public async up(q: QueryRunner): Promise<void> {
        await q.query(
            `CREATE TABLE "wikidata_program" ("qid" text PRIMARY KEY NOT NULL,"title" text NOT NULL,"strictKey" text NOT NULL,"syobocalTid" integer,"tmdbId" integer,"updatedAt" bigint NOT NULL)`,
        );
        ...
        await q.query(
            `CREATE TABLE "wikidata_program_alias" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL,"strictKey" text NOT NULL,"qid" text NOT NULL,"rank" integer NOT NULL DEFAULT (2))`,
        );
