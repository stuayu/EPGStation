...
export class Init1601185891878 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            'CREATE TABLE "rule" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "updateCnt" integer NOT NULL DEFAULT (0), "isTimeSpecification" boolean NOT NULL DEFAULT (0), "keyword" text, "halfWidthKeyword" text, "ignoreKeyword" text, "halfWidthIgnoreKeyword" text, "keyCS" boolean NOT NULL DEFAULT (0), "keyRegExp" boolean NOT NULL DEFAULT (0), "name" boolean NOT NULL DEFAULT (0), "description" boolean NOT NULL DEFAULT (0), "extended" boolean NOT NULL DEFAULT (0), "ignoreKeyCS" boolean NOT NULL DEFAULT (0), "ignoreKeyRegExp" boolean NOT NULL DEFAULT (0), "ignoreName" boolean NOT NULL DEFAULT (0), "ignoreDescription" boolean NOT NULL DEFAULT (0), "ignoreExtended" boolean NOT NULL DEFAULT (0), "GR" boolean NOT NULL DEFAULT (0), "BS" boolean NOT NULL DEFAULT (0), "CS" boolean NOT NULL DEFAULT (0), "SKY" boolean NOT NULL DEFAULT (0), "NW1" boolean NOT NULL DEFAULT (0), "NW2" boolean NOT NULL DEFAULT (0), "NW3" boolean NOT NULL DEFAULT (0), "NW4" boolean NOT NULL DEFAULT (0), "NW5" boolean NOT NULL DEFAULT (0), "NW6" boolean NOT NULL DEFAULT (0), "NW7" boolean NOT NULL DEFAULT (0), "NW8" boolean NOT NULL DEFAULT (0), "NW9" boolean NOT NULL DEFAULT (0), "NW10" boolean NOT NULL DEFAULT (0), "NW11" boolean NOT NULL DEFAULT (0), "NW12" boolean NOT NULL DEFAULT (0), "NW13" boolean NOT NULL DEFAULT (0), "NW14" boolean NOT NULL DEFAULT (0), "NW15" boolean NOT NULL DEFAULT (0), "NW16" boolean NOT NULL DEFAULT (0), "NW17" boolean NOT NULL DEFAULT (0), "NW18" boolean NOT NULL DEFAULT (0), "NW19" boolean NOT NULL DEFAULT (0), "NW20" boolean NOT NULL DEFAULT (0), "NW21" boolean NOT NULL DEFAULT (0), "NW22" boolean NOT NULL DEFAULT (0), "NW23" boolean NOT NULL DEFAULT (0), "NW24" boolean NOT NULL DEFAULT (0), "NW25" boolean NOT NULL DEFAULT (0), "NW26" boolean NOT NULL DEFAULT (0), "NW27" boolean NOT NULL DEFAULT (0), "NW28" boolean NOT NULL DEFAULT (0), "NW29" boolean NOT NULL DEFAULT (0), "NW30" boolean NOT NULL DEFAULT (0), "NW31" boolean NOT NULL DEFAULT (0), "NW32" boolean NOT NULL DEFAULT (0), "NW33" boolean NOT NULL DEFAULT (0), "NW34" boolean NOT NULL DEFAULT (0), "NW35" boolean NOT NULL DEFAULT (0), "NW36" boolean NOT NULL DEFAULT (0), "NW37" boolean NOT NULL DEFAULT (0), "NW38" boolean NOT NULL DEFAULT (0), "NW39" boolean NOT NULL DEFAULT (0), "NW40" boolean NOT NULL DEFAULT (0), "channelIds" text, "genres" text, "times" text, "isFree" boolean NOT NULL DEFAULT (0), "durationMin" integer, "durationMax" integer, "searchPeriods" text, "enable" boolean NOT NULL DEFAULT (0), "avoidDuplicate" boolean NOT NULL DEFAULT (0), "periodToAvoidDuplicate" integer, "allowEndLack" boolean NOT NULL DEFAULT (1), "tags" text, "parentDirectoryName" text, "directory" text, "recordedFormat" text, "mode1" text, "parentDirectoryName1" text, "directory1" text, "mode2" text, "parentDirectoryName2" text, "directory2" text, "mode3" text, "parentDirectoryName3" text, "directory3" text, "isDeleteOriginalAfterEncode" boolean NOT NULL DEFAULT (0))',
        );
        await queryRunner.query(
