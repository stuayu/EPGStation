    ...
    <div class="recorded-item-menu">
        <v-menu class="menu" v-model="isOpened" location="bottom start">
            ...
            <v-list>
                ...
                <v-list-item v-if="recordedItem.isRecording === false && serverConfig.isEnableEncode() === true" v-on:click="openEncodeDialog" slim>
                    <template #prepend>
                ...
                <v-list-item v-if="recordedItem.isEncoding === true" v-on:click="stopEncode" slim>
                    <template #prepend>
