...
import Encode from './views/Encode.vue'; import Guide from './views/Guide.vue'; import GuideSizeSetting from './views/GuideSizeSetting.vue';
...
export default createRouter({ history: createWebHashHistory(), routes: [
    { path: '/', name: 'dashboard', component: Dashboard }, { path: '/onair', name: 'onair', component: OnAir },
    { path: '/onair/watch', name: 'watch-onair', component: WatchOnAir }, { path: '/guide', name: 'guide', component: Guide },
    { path: '/guide/setting', name: 'guide-setting', component: GuideSizeSetting }, { path: '/reserves', name: 'reserves', component: Reserves },
    { path: '/reserves/manual', name: 'manual-reserve', component: ManualReserve }, { path: '/recording', name: 'recording', component: Recording },
    { path: '/recorded', name: 'recorded', component: Recorded }, { path: '/recorded/upload', name: 'recorded-upload', component: RecordedUpload },
    { path: '/recorded/watch', name: 'recorded-watch', component: WatchRecorded }, { path: '/recorded/detail/:id', name: 'recorded-detail', component: RecordedDetail },
